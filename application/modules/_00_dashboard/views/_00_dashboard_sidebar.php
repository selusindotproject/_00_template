...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="<?php echo site_url() ?>auth/logout"><i class="fa fa-circle text-red"></i> <span>Logout</span></a></li>
            <?php } else { ?>
            <li><a href="<?php echo site_url() ?>auth/login"><i class="fa fa-circle text-green"></i> <span>Login</span></a></li>
            <?php }?>
            <!-- /Login or logout -->
